...
int main(int argc, char const *argv[])
{
    ...
    while (true)
    {
        ...
        std::cout << "--------------------- \n";
        std::cout << "FPS (total): " << 1 / ((elapsed_time.count())/1e+6) << "\n";
        std::cout << "GFLOPS (kernel): " << (2*new_size*new_size*(2*FILTER_RADIUS+1)*(2*FILTER_RADIUS+1) * 1e-9) / (elapsed_time.count()/1e+6) << "\n";
        std::cout << "------------------------------------ \n";
        std::cout << "\n";

...
int main(int argc, char const *argv[])
{
    ...
    stbi_write_png("data/img_output/gpu_pinnedTiled_benchmark_output_img.png", n_cols, n_rows, 1, ucharData.data(), n_cols);

    // ----------------------------------------------------------------- //
    // ------------------ Saving benchmark results --------------------- //
    // ----------------------------------------------------------------- //
    // Opening File
    const std::string filename = "benchmarking/gpu_pinnedTiled.txt";
    ...
    // Writing results
    file << "--------------------------------------------- \n";
    file << "GPU (Pinned with Tiling) Benchmarking details \n";
    file << "--------------------------------------------- \n";

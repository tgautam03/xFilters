...
int main(int argc, char const *argv[])
{
    ...
    float *P_CPU = new float[new_size * new_size];
    ...
    stbi_write_png("data/img_output/gpu_tiled_benchmark_output_img.png", n_cols, n_rows, 1, ucharData.data(), n_cols);

    // ----------------------------------------------------------------- //
    // ------------------ Saving benchmark results --------------------- //
    // ----------------------------------------------------------------- //
    // Opening File
    const std::string filename = "benchmarking/gpu_tiled.txt";
    ...
    // Writing results
    file << "--------------------------------- \n";
    file << "GPU (Tiling) Benchmarking details \n";
    file << "--------------------------------- \n";
